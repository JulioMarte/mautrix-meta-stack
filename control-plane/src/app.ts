    ...
    .post("/internal/v1/matrix/events", async ({ request, body, set }) => {
      ...
      try {
        ...
        const terminalCodes = new Set([
          "CONNECTION_NOT_FOUND", "TENANT_NOT_ACTIVE", "CONNECTION_NOT_ACTIVE", "CHATWOOT_BINDING_REQUIRED",
          "CHATWOOT_BINDING_NOT_ACTIVE", "CROSS_TENANT_CHATWOOT_BINDING", "CROSS_TENANT_CONVERSATION_BINDING",
          "CHATWOOT_ROUTE_MISMATCH", "CHATWOOT_ROUTE_AMBIGUOUS", "INCOMPLETE_CONVERSATION_BINDING",
          "EVENT_IDENTITY_CONFLICT", "MATRIX_ROOM_BINDING_CONFLICT", "EMPTY_MESSAGE", "CHATWOOT_ATTACHMENT_LIMIT_EXCEEDED",
          "MATRIX_MEDIA_ENCRYPTION_INVALID", "MATRIX_MEDIA_HASH_MISMATCH"
        ]);
