...
def main() -> None:
    ...
    replace_once(
        ...
        '''const matrixRemoteSenderIDKey = "com.mautrix_meta_stack.remote_sender_id"\n\nfunc annotateMatrixRemoteSender(message *bridgev2.ConvertedMessage, senderID string) *bridgev2.ConvertedMessage {\n\tif message == nil || senderID == "" {\n\t\treturn message\n\t}\n\tfor _, part := range message.Parts {\n\t\tif part == nil {\n\t\t\tcontinue\n\t\t}\n\t\tif part.Extra == nil {\n\t\t\tpart.Extra = make(map[string]any)\n\t\t}\n\t\tpart.Extra[matrixRemoteSenderIDKey] = senderID\n\t}\n\treturn message\n}\n\ntype FBMessageEvent struct {\n''',
    )
